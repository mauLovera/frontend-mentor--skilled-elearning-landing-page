...
const buttonOrLinkStyles = cva(
  "flex items-center justify-center transition-colors duration-300 w-fit",
  {
    variants: {
      intent: {
        header:
          "text-button-sm-tall px-6 pt-[9px] pb-[11px] md:px-8 md:py-[14px] bg-blue hover:bg-blue-hover text-white rounded-[28px]",
        primary:
        ...
        footer:
          "text-button-sm-tall px-[24px] pt-[9px] pb-[11px] md:px-8 md:py-[14px] bg-gradient-to-b from-purple to-hot-pink rounded-[28px] text-white",
      },
    },
    defaultVariants: {
      intent: "primary",
